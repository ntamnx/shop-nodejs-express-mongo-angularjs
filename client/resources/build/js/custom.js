...
function init_sidebar() {
    $('.remove-active-menu').click(function () {
        var slector = $('#sidebar-menu').find('li.active:first');
        slector.removeClass('active');
        slector.find('ul:first').css('display','none');
        $('#sidebar-menu').find('li.active:first').find('a:first').trigger('click');
    });
...
//        $RIGHT_COL.css('min-height', contentHeight);
    ...
    $SIDEBAR_MENU.find('a').on('click', function (ev) {
        var $li = $(this).parent();
        if($li.find('ul').length && $li.is('.active')){
            return false;
        }
        if ($li.is('.active')) {
